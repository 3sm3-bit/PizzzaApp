package com.pizzza.pizzzaapp.service
...
import com.pizzza.pizzzaapp.utils.AudioQueueManager
...
class WebSocketService : Service() {
    ...
    private fun createNotification(): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setSmallIcon(com.pizzza.pizzzaapp.R.mipmap.ic_launcher)
            .setOngoing(true)
            .build()
    }
    ...
    private fun setupWebSocket() {
        ...
        webSocketManager.notifications
            .onEach { notification ->
                println("$TAG_PIZZZA: Service - Pedido Recibido: ${notification.titulo}")
    ...
    override fun onDestroy() {
        println("$TAG_PIZZZA: WebSocketService - Servicio detenido por el usuario")
